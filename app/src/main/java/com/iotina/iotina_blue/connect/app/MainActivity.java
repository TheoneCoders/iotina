package com.iotina.iotina_blue.connect.app;
...
import com.iotina.iotina_blue.Camera.Camera;
import com.iotina.iotina_blue.R;
import com.iotina.iotina_blue.connect.app.neopixel.NeopixelActivity;
import com.iotina.iotina_blue.connect.app.settings.SettingsActivity;
import com.iotina.iotina_blue.connect.app.update.FirmwareUpdater;
import com.iotina.iotina_blue.connect.app.update.ReleasesParser;
import com.iotina.iotina_blue.connect.ble.BleDevicesScanner;
import com.iotina.iotina_blue.connect.ble.BleManager;
import com.iotina.iotina_blue.connect.ble.BleUtils;
import com.iotina.iotina_blue.connect.ui.utils.DialogUtils;
import com.iotina.iotina_blue.connect.ui.utils.ExpandableHeightExpandableListView;
...
/*
    ...
    private void showChooseDeviceServiceDialog(final BluetoothDeviceData deviceData) {
        ...
        int i = 0;
        for (i = 0; i < kComponentsNameIds.length; i++)
                ...
                .setItems(items, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        switch (kComponentsNameIds[which]) {
                            ...
                            case R.string.camera_activity: {   // camera
                                mComponentToStartWhenConnected = Camera.class;
                                break;
                            }
    ...
    public void onClickDeviceConnect(int scannedDeviceIndex) {
        ...
        if (scannedDeviceIndex < filteredPeripherals.size()) {
            ...
            if (mSelectedDeviceData.type == BluetoothDeviceData.kType_Uart) {      // if is uart, show all the available activities
                ...
                Toast.makeText(this, "No UART service found. Go to InfoActivity", Toast.LENGTH_LONG).show();
                mComponentToStartWhenConnected = Camera.class;
                connect(device);
            }
        } else {
